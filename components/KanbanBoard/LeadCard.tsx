    ...
    return (
        ...
        >
            ...
            <div className="border-t border-gray-200 dark:border-gray-600 pt-2 text-xs text-gray-500 dark:text-gray-400 space-y-1.5">
                ...
                {lead.followUpDateTime && <p className="flex items-center">
                    <FiCalendar className="w-3.5 h-3.5 mr-2" /> Follow-up: <span className="font-medium text-gray-700 dark:text-gray-300 ml-1">{new Date(lead.followUpDateTime).toLocaleDateString()}</span>
                </p>}
            </div>
